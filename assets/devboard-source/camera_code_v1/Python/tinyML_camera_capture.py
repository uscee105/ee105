#!/usr/bin/env python3
# Tiny ML Kit Image Capture
# Simple GUI to display and save images received over a serial port. 
# Images must be encoded in base64 with the appropriate EIML protocol header. 
