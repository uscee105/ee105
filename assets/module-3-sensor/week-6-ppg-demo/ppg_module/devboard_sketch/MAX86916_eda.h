...
#define MAX86916_eda_ADDRESS          0x57 //7-bit I2C Address
...
class MAX86916_eda {
 public: 
  ...
  boolean begin(TwoWire &wirePort = Wire, uint32_t i2cSpeed = I2C_SPEED_STANDARD , uint8_t i2caddr = MAX86916_eda_ADDRESS);
  //boolean begin(uint32_t i2cSpeed = I2C_SPEED_STANDARD , uint8_t i2caddr = MAX86916_eda_ADDRESS);
  ...
  void setup(byte powerLevel = 0x00, byte sampleAverage = 1, byte ledMode = 4, int sampleRate = 400, int pulseWidth = 411, int adcRange = 16384);
